            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-slate-800 border border-slate-600 shadow-sm">
                ...
                <p className="text-sm text-slate-200 leading-relaxed">
                  3 or 4 tiles of the <strong className="text-white">same number value</strong> with <strong className="text-white">different colors</strong> (e.g. Red 7, Blue 7, Black 7, Orange 7).
                </p>
              </div>
